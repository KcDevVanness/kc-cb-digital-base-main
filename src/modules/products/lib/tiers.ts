 ...
 *
 * `purchase` — what we pay for the goods: the supplier's price for a purchased line, the
 *              production cost for a self-made or commission-produced one.
 ...
 * code list keeps a printed contract readable without joining a lookup table. `purchase` keeps
 * its code for that reason even though the label is now the general "cost price".
 */
