...
export const CONTAINER_TYPE_SEEDS = [
  ...
  { value: 'GUANGZHOU_LOGISTICS_KAPRO', label: '广州物流', position: 70 },
] as const
 ...
 * list in the dictionary library.
 *
 * A dictionary entry is **data**, not UI: it cannot switch language per reader, so a label is
 * written in one language only (the deployment's business language here). The English name of a
 * foreign port belongs on the document that needs it, not duplicated inside the label.
 */
export const PORT_SEEDS = [
  { value: '深圳盐田', label: '深圳盐田', position: 10 },
  { value: '深圳蛇口', label: '深圳蛇口', position: 20 },
  { value: '广州南沙', label: '广州南沙', position: 30 },
  { value: '宁波', label: '宁波', position: 40 },
  { value: '上海', label: '上海', position: 50 },
  { value: '青岛', label: '青岛', position: 60 },
  { value: '天津', label: '天津', position: 70 },
  { value: '厦门', label: '厦门', position: 80 },
  { value: '香港', label: '香港', position: 90 },
  { value: '东方港', label: '东方港', position: 100 },
  { value: '圣彼得堡', label: '圣彼得堡', position: 110 },
  { value: '莫斯科', label: '莫斯科', position: 120 },
  { value: '新加坡', label: '新加坡', position: 130 },
] as const

/** Carriers and forwarders booked on shipments (承运人): the vessel operators first, then the couriers. */
export const CARRIER_SEEDS = [
  { value: '中远海运', label: '中远海运', position: 10 },
  { value: '马士基', label: '马士基', position: 20 },
  { value: '地中海航运', label: '地中海航运', position: 30 },
  { value: '达飞', label: '达飞', position: 40 },
  { value: '长荣', label: '长荣', position: 50 },
  { value: '东方海外', label: '东方海外', position: 60 },
  { value: '赫伯罗特', label: '赫伯罗特', position: 70 },
  { value: '海洋网联', label: '海洋网联', position: 80 },
  { value: '海丰', label: '海丰', position: 90 },
  { value: '顺丰', label: '顺丰', position: 100 },
...
const DICTIONARY_SEEDS: readonly DictionarySeed[] = [
  ...
  },
  {
    ...
    name: 'Ports',
    description: 'Departure and destination ports offered on shipments and contracts',
    entries: PORT_SEEDS,
  },
  {
    key: CARRIER_DICTIONARY_KEY,
    name: 'Carriers',
    description: 'Carriers and forwarders offered on shipments',
