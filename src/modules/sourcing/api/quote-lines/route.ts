...
const quoteLineListItemSchema = z
  .object({
    ...
    outerPacking: z.unknown().nullable().optional(),
...
export const { metadata, GET, POST, PUT, DELETE } = makeCrudRoute({
  ...
  list: {
    ...
    transformItem: (item: Record<string, unknown>) => ({
      ...
      cartons: asNullableNumber(item.cartons),
      ...
      outerPacking: item.outer_packing ?? null,
      cartonVolume: asNullableString(item.carton_volume),
      raw: item.raw ?? null,
